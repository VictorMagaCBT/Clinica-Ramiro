			...
			<div className="firstRowHome">
				<div className="welcomeMsg">
					...
					<p>
						...
						aqueles que vêm de longe para buscar tratamento especializado. Reconhecemos a importância do 
						turismo da saúde e estamos prontos para atender às suas necessidades, proporcionando uma 
						experiência médica excepcional.
					</p>
					<p>
						Explore o nosso site para descobrir mais sobre os nossos serviços, a nossa equipa altamente qualificada
						e a nossa filosofia de cuidado centrado no paciente. Estamos ansiosos para conhecê-lo e ajudá-lo 
