        ...
        <div className="content-Inclusos">
            ...
            <div className="introductionInclusos">
                ...
                <p className="introduction-text-Inclusos text-center">
                    Dentes inclusos, um enigma bucal! 
                    <br/><br/>
                    Às vezes, nossos dentes decidem brincar de esconde-esconde. Imagine um dente que não encontra o caminho certo para sair e decide se aconchegar no osso. 
                    É aí que entra a cirurgia para remoção de dentes inclusos
                    <br/><br/> - uma verdadeira expedição odontológica!</p>
            </div>
            <div className="photo3d-part">
                <p className="inclusos-text text-center">
                    Os dentes inclusos são como tesouros escondidos no subsolo da sua boca.
                    <br/><br/>
                    Às vezes, são incômodos, às vezes invisíveis, mas sempre intrigantes.
                    <br/><br/>
                    A cirurgia é um jogo de habilidade, paciência e precisão, onde os especialistas odontológicos desvendam
                    o enigma, removendo esses dentes teimosos e restaurando o equilíbrio no seu sorriso.
                </p>
